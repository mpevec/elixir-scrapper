defmodule ScrappingExample.Repo.Migrations.AddPropertyNetAd do
  use Ecto.Migration

  def change do
    create table("property_net_ad", primary_key: false) do
      add :id_property_net_ad, :serial, primary_key: true
